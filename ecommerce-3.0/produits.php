...
<body>
    ...
    <div class="container py-2">
        ...
        <a href="ajouter_produit.php" class="btn btn-primary float-end btn-sm">Ajouter produit</a>
            ...
            <tbody>
                ...
                foreach ($categories as $produit) {
                    ...
                    <tr>
                        ...
                        <td><img class="img-fluid" width="90" src="upload/produit/<?= $produit->image ?>"
                                alt="<?= $produit->libelle ?>"></td>
                        <td>
                            <a class="btn btn-primary btn-sm"
                                href="modifier_produit.php?id=<?php echo $produit->id ?>">Modifier</a>
                            <a class="btn btn-danger btn-sm" href="supprimer_produit.php?id=<?php echo $produit->id ?>"
