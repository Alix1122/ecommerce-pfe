...
<body>
    ...
    <div class="container py-2">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img class="img-fluid produit-image" src="../upload/produit/<?php echo $produit['image'] ?>" alt="">
                </div>
                <div class="col-md-6">
                    <?php
                    ...
                    <div class="d-flex">
                        ...
                        if (!empty($discount)) {
                            ...
                            ?>
                            <h5 class="mx-1">
                                <span class="badge text-bg-danger"><strike> <?php echo $prix ?> <i
                                            class="fa fa-solid fa-dollar"></i> </strike></span>
                            </h5>
                            <h5 class="mx-1">
                                <span class="badge text-bg-success"><?php echo $total ?> <i
                                        class="fa fa-solid fa-dollar"></i></span>
                            </h5>
                    ...
                    <div class="size-section">
                        <label class="size-label"><i class="fa fa-tag"></i> Taille :</label>
